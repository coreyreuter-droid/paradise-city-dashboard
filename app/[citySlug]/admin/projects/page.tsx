      ...
      >
        <div className="space-y-4">
          ...
          {state === "loaded" && projects.length === 0 && (
            <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50 px-6 py-12 text-center" role="status">
                  ...
                  {projects.map((project) => {
                    ...
                    return (
                      <tr key={project.id} className="hover:bg-slate-50">
                        ...
                        <td className="px-4 py-3">
                          <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium whitespace-nowrap ${status.bg} ${status.text}`}>
                            {status.label}
                          </span>
                        </td>
