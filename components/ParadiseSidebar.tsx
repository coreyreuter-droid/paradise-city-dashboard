...
export default function ParadiseSidebar({
  ...
  return (
    ...
    >
      ...
      <div className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between border-b border-slate-200 bg-white/95 px-3 py-2 shadow-sm backdrop-blur-sm sm:hidden">
